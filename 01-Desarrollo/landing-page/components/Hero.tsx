        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="bg-white rounded-xl shadow-2xl overflow-hidden max-w-[380px] mx-auto border border-gray-200">
              {/* WhatsApp Header */}
              <div className="bg-[#008069] px-4 py-2 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className="text-white font-medium text-sm">Clínica Dental Sonrisa</p>
              ...
              {/* WhatsApp Chat Background - Light theme wallpaper */}
              <div className="relative h-[600px] overflow-hidden" style={{
                backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23d0d9d4' fill-opacity='0.4'%3E%3Cpath d='M0 40L40 0H20L0 20M40 40V20L20 40'/%3E%3C/g%3E%3C/svg%3E")`,
                ...
                <div className="relative p-3 space-y-2 h-full overflow-y-auto custom-scrollbar">
                  ...
                  <div className="flex justify-center my-2">
                    <span className="bg-[#e1f5fe] text-[#667781] text-xs px-3 py-1 rounded-lg">HOY</span>
                  </div>
                  ...
                  >
                    <div className="bg-white rounded-lg px-3 py-2 relative shadow-sm">
                      <p className="text-[#111b21] text-sm">¡Hola! Le recordamos su cita mañana a las 3:00 PM con el Dr. Rodríguez 🦷</p>
                      <p className="text-[#667781] text-[11px] mt-1 text-right">2:45 PM</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="bg-[#d9fdd3] rounded-lg px-3 py-2 relative shadow-sm">
                      <p className="text-[#111b21] text-sm">Perfecto, ahí estaré!</p>
                      <div className="flex items-center justify-end gap-1 mt-1">
                        <p className="text-[#667781] text-[11px]">2:46 PM</p>
                  ...
                  >
                    <div className="bg-white rounded-lg px-3 py-2 relative shadow-sm">
                      <p className="text-[#111b21] text-sm">Excelente! Le confirmo entonces:</p>
                      <p className="text-[#111b21] text-sm mt-1">📅 Viernes 15 de marzo</p>
                      <p className="text-[#111b21] text-sm">⏰ 3:00 PM</p>
                      <p className="text-[#111b21] text-sm">👨‍⚕️ Dr. Rodríguez</p>
                      <p className="text-[#667781] text-[11px] mt-1 text-right">2:46 PM</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="bg-[#d9fdd3] rounded-lg px-3 py-2 relative shadow-sm">
                      <p className="text-[#111b21] text-sm">¿Puedo llevar a mi niña?</p>
                      <div className="flex items-center justify-end gap-1 mt-1">
                        <p className="text-[#667781] text-[11px]">2:47 PM</p>
                        <svg className="w-4 h-3 text-[#53bdeb]" viewBox="0 0 16 11" fill="currentColor">
                          <path d="M11.071.653a.5.5 0 0 1 .708 0l3.84 3.84a.5.5 0 0 1-.708.707L11.07 1.36 5.354 7.076a.5.5 0 0 1-.708 0L.146 2.576a.5.5 0 0 1 .708-.707l4.146 4.147L11.071.653z"/>
                          <path d="M15.621 3.84l-3.83 3.83a.5.5 0 0 1-.708 0L5.354 1.94a.5.5 0 1 1 .708-.707L11.79 6.96l3.13-3.13a.5.5 0 0 1 .708.707z"/>
                        </svg>
                  ...
                  >
                    <div className="bg-white rounded-lg px-3 py-2 relative shadow-sm">
                      <p className="text-[#111b21] text-sm">¡Por supuesto! El Dr. Rodríguez es excelente con los niños 👶</p>
                      <p className="text-[#667781] text-[11px] mt-1 text-right">2:47 PM</p>
                    </div>
                  </motion.div>
                  ...
                  <motion.div
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: 9.5, duration: 0.3 }}
                    className="flex gap-2 max-w-[85%]"
                  >
                    <div className="bg-white rounded-lg px-3 py-2 relative shadow-sm">
                      <p className="text-[#111b21] text-sm">📍 Le recuerdo nuestra dirección:</p>
                      <p className="text-[#111b21] text-sm">Av. Winston Churchill #123, Santo Domingo</p>
                      <p className="text-[#667781] text-[11px] mt-1 text-right">2:48 PM</p>
                    </div>
                  </motion.div>
                  ...
                  <motion.div
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: 10.5, duration: 0.3 }}
                    className="flex gap-2 max-w-[85%]"
                  >
                    <div className="bg-white rounded-lg px-3 py-2 relative shadow-sm">
                      <p className="text-[#111b21] text-sm">💡 Consejo: Llegue 10 minutos antes para completar el papeleo</p>
                      <p className="text-[#667781] text-[11px] mt-1 text-right">2:48 PM</p>
                    </div>
                  </motion.div>
                  ...
                  <motion.div
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: 11.5, duration: 0.3 }}
                    className="flex gap-2 max-w-[85%]"
                  >
                    <div className="bg-white rounded-lg px-3 py-2 relative shadow-sm">
                      <p className="text-[#111b21] text-sm">Si necesita cambiar o cancelar su cita, solo escriba "CAMBIAR" 📝</p>
                      <p className="text-[#667781] text-[11px] mt-1 text-right">2:48 PM</p>
                    </div>
                  </motion.div>
                ...
                {/* WhatsApp Input Bar */}
                <div className="absolute bottom-0 left-0 right-0 bg-[#f0f2f5] p-2 flex items-center gap-3">
                  <svg className="w-6 h-6 text-[#54656f]" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM7 9a1 1 0 100-2 1 1 0 000 2zm7-1a1 1 0 11-2 0 1 1 0 012 0zm-.464 5.535a1 1 0 10-1.415-1.414 3 3 0 01-4.242 0 1 1 0 00-1.415 1.414 5 5 0 007.072 0z" clipRule="evenodd" />
                  </svg>
                  <div className="flex-1 bg-white rounded-3xl px-4 py-2 flex items-center border border-gray-200">
                    <span className="text-[#667781] text-sm">Escribe un mensaje</span>
                  </div>
                  <svg className="w-6 h-6 text-[#54656f]" fill="currentColor" viewBox="0 0 20 20">
