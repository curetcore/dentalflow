...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/10 via-cyan-500/10 to-secondary/10 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-20 right-20 w-64 h-64 bg-gradient-to-br from-primary/30 to-cyan-500/30 rounded-full blur-3xl"
        />
        <motion.div
          animate={{ 
            y: [0, 20, 0],
          ...
          className="absolute bottom-20 left-20 w-80 h-80 bg-gradient-to-tr from-secondary/30 to-cyan-500/30 rounded-full blur-3xl"
        />
